...
public abstract class BwPrincipal implements AccessPrincipal, Comparable<BwPrincipal>,
  ...
  public static String makePrincipalHref(final String id,
    ...
    if (root == null) {
      throw new AccessException("Unknown Principal Type");
    }
  ...
  public static void toStringSegment(final ToString ts,
    ...
    if (val == null) {
      ...
      ts.append(name, "(" + val.getPrincipalRef() + ")");
    }
  }
  ...
  public int compare(final BwPrincipal p1, final BwPrincipal p2) {
    ...
    return Util.compareStrings(p1.getAccount(), p2.getAccount());
  }
